 ...
 */
double _jaro_winkler(const char *ying, const char *yang, bool long_tolerance, bool winklerize, bool average)
{
    /* Arguments:
    ...
    weight /= 3.0;
    double nonWinklerWeight = weight;
    ...
    if (average)
    {
        return 0.5 * (nonWinklerWeight + weight);
    }

    return weight;
}

double jaro_average(const char *ying, const char *yang)
{
    return _jaro_winkler(ying, yang, true, true, true);
}

double jaro_winkler(const char *ying, const char *yang, bool long_tolerance)
{
    return _jaro_winkler(ying, yang, long_tolerance, true, false);
}

double jaro_distance(const char *ying, const char *yang)
{
    return _jaro_winkler(ying, yang, false, false, false);
}
